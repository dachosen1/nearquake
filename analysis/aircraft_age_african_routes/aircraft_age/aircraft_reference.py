...
AIRCRAFT_TYPES: dict[str, AircraftType] = {
    ...
    "32A": AircraftType("32A", "Airbus A320 (sharklets)", 1988, NARROWBODY, 150,
                        "generic A320 code"),
    "32S": AircraftType("32S", "Airbus A320 family", 1988, NARROWBODY, 150,
    ...
    "737": AircraftType("737", "Boeing 737-700", 1998, NARROWBODY, 143, "generic 737NG code"),
    ...
    "757": AircraftType("757", "Boeing 757-200", 1983, NARROWBODY, 200, "generic 757 code"),
    # ---- Boeing 767 ----
    ...
    "767": AircraftType("767", "Boeing 767-300", 1986, WIDEBODY, 218, "generic 767 code"),
    # ---- Boeing 777 ----
    ...
    "777": AircraftType("777", "Boeing 777-200", 1995, WIDEBODY, 314, "generic 777 code"),
    # ---- Boeing 747 ----
    "744": AircraftType("744", "Boeing 747-400", 1989, WIDEBODY, 416),
    "74M": AircraftType("74M", "Boeing 747-400M Combi", 1989, WIDEBODY, 290),
    "747": AircraftType("747", "Boeing 747-400", 1989, WIDEBODY, 416, "generic 747 code"),
    # ---- Boeing 787 ----
    ...
    # ---- McDonnell Douglas ----
    "M80": AircraftType("M80", "McDonnell Douglas MD-80", 1980, NARROWBODY, 140,
                        "generic MD-80 code"),
    ...
    # ---- Regional jets ----
    "CRJ": AircraftType("CRJ", "Bombardier CRJ-200", 1992, REGIONAL_JET, 50, "generic CRJ code"),
    ...
    "EMJ": AircraftType("EMJ", "Embraer E-Jet (family)", 2004, REGIONAL_JET, 88,
                        "generic Embraer E-Jet code"),
    "ER4": AircraftType("ER4", "Embraer ERJ-145", 1996, REGIONAL_JET, 50),
    "ERJ": AircraftType("ERJ", "Embraer ERJ (family)", 1996, REGIONAL_JET, 50,
    ...
    "FRJ": AircraftType("FRJ", "Fairchild Dornier 328JET", 1999, REGIONAL_JET, 32,
    ...
    "DH8": AircraftType("DH8", "Bombardier Dash 8", 1984, TURBOPROP, 50, "generic Dash 8 code"),
